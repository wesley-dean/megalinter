...
ARG PIP_CFN_LINT_VERSION=1.32.1
...
ARG NPM_STYLELINT_VERSION=16.17.0
...
ARG GO_GOLANGCI_LINT_VERSION=2.0.2
...
ARG PHP_VIMEO_PSALM_VERSION=6.9.5
...
ARG PIP_CHECKOV_VERSION=3.2.393
...
ARG GEM_RUBOCOP_VERSION=1.75.1
