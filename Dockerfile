...
ARG REPOSITORY_TRUFFLEHOG_VERSION=3.88.20
...
ARG NPM_SALESFORCE_CLI_VERSION=2.81.9
...
ARG PHP_VIMEO_PSALM_VERSION=6.10.0
...
ARG PIP_CHECKOV_VERSION=3.2.394
...
ARG REPOSITORY_TRIVY_VERSION=0.61.0
# renovate: datasource=github-tags depName=aquasecurity/trivy
ARG REPOSITORY_TRIVY_SBOM_VERSION=0.61.0
...
ARG NPM_TYPESCRIPT_ESLINT_ESLINT_PLUGIN_VERSION=8.28.0
# renovate: datasource=npm depName=@typescript-eslint/parser
ARG NPM_TYPESCRIPT_ESLINT_PARSER_VERSION=8.28.0
