...
ARG REPOSITORY_TRUFFLEHOG_VERSION=3.88.18
...
ARG NPM_SALESFORCE_CLI_VERSION=2.78.3
# renovate: datasource=npm depName=@salesforce/plugin-packaging
ARG NPM_SALESFORCE_PLUGIN_PACKAGING_VERSION=2.10.3
# renovate: datasource=npm depName=sfdx-hardis
ARG SFDX_HARDIS_VERSION=5.24.1
...
ARG PIP_CFN_LINT_VERSION=1.32.0
...
ARG NPM_STYLELINT_VERSION=16.16.0
...
ARG NPM_ESLINT_PLUGIN_N_VERSION=17.17.0
# renovate: datasource=npm depName=eslint-plugin-prettier
ARG NPM_ESLINT_PLUGIN_PRETTIER_VERSION=5.2.5
...
ARG KUBERNETES_KUBESCAPE_VERSION=3.0.32
...
ARG PHP_PHPSTAN_PHPSTAN_VERSION=2.1.10
...
ARG PHP_VIMEO_PSALM_VERSION=6.9.4
...
ARG GEM_RUBOCOP_VERSION=1.74.0
...
ARG SALESFORCE_SFDX_SCANNER_VERSION=4.10.0
# renovate: datasource=npm depName=lightning-flow-scanner
ARG LIGHTNING_FLOW_SCANNER_VERSION=3.2.0
...
ARG NPM_TYPESCRIPT_ESLINT_ESLINT_PLUGIN_VERSION=8.27.0
# renovate: datasource=npm depName=@typescript-eslint/parser
ARG NPM_TYPESCRIPT_ESLINT_PARSER_VERSION=8.27.0
...
ARG PIP_VIRTUALENV_VERSION=20.29.3
# renovate: datasource=github-tags depName=rust-lang/rust
ARG RUST_RUST_VERSION=1.85.1
